...
#
# 背景: クラスタ node role (別アカ 159553542841) には自アカウント (776010787911)
...
#
# 環境:
#   BUCKET (default: akazawt-disagg-b300-776010787911)
#   AWS_PROFILE (default: default), REGION (default: us-west-2), NAMESPACE (default: akazawt-disagg)
set -euo pipefail
